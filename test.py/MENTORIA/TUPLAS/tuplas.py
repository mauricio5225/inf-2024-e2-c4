...
while True:
    ...
    if opcion == 0:
        ...
        filtrados_impares = tuple(filter(lambda x: x % 2 != 0, lista))
...
tupla = ("hla","manzana","ciruela",2,4,2,3,4,5,2)
print(tupla)
tupla = ("hla","manzana",2)
print(tupla)
...
#conjuntos
con ={1,5,3,"hola","mundo",7,"mfb",5,6,5}
print (con)

#Diccionarios
mfb={"mauro":21,"gabo":20,"nico":10, "tomy":15}
print(mfb)
print(mfb["mauro"])


autos ={"fiat":"uno","Nissan":"Kicks",
              "toyota":"corolla"}
for marcas, tipos in autos.items(): 
  print(marcas,tipos)
